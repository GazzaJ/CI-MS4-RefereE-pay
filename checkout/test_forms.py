...
class TestOrderForm(TestCase):
    ...
    def test_fields_are_explicit_in_form_metaclass(self):
        form = OrderForm()
        self.assertEqual(form.Meta.fields, ('full_name', 'email', 'phone_number', 'street_address1', 'street_address2', 'town_or_city', 'postcode', 'county_or_state', 'country'))
    ...
    def test_fields_not_required(self):
        form = OrderForm({
            'full_name': 'Gareth John',
            'email': 'johnge71@gmail.com',
